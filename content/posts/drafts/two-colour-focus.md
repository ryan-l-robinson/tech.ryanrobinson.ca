...
One approach is to have the same focus style on the entire site. This might cause a problem in that the style will show up better in some contexts than in others, e.g. if it is a dark border that won't show up as well in the menu with a dark background as in a lot of menu areas as it does in the white background main area.
